...
<?= $entity_class_name ?>.show.boxtitle: 'Détail un <?= $entity_class_name ?>'
<?= $entity_class_name ?>.show.btn.supprimer: 'Supprimer'
<?= $entity_class_name ?>.show.btn.retourliste: 'Retour à la liste'
<?= $entity_class_name ?>.show.pagetitle: 'Détail un <?= $entity_class_name ?>'
<?= $entity_class_name ?>.show.subtitle: ''
<?= $entity_class_name ?>.form.btn_fermer: 'Fermer'
<?= $entity_class_name ?>.form.btn_valider: 'Valider'
