...
namespace Sbyaute\TwigBootstrapMakerBundle\Maker;
...
class MakeTwigBootstrapCrudModal extends AbstractMaker
{
    ...
    {
        return 'make:twigbootstrap:crudmodal';
    }
    ...
    {
        $command
            ->setDescription('Creates TwigBootstrap CRUD (modal mode) for Doctrine entity class')
